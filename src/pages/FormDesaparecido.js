    ...
    <!-- Form del objeto o persona perdida -->
        <div class="form" id="objPerdido">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombresD" class="form-control" >
            </div>
            <div class="mb-3">
                <a href="#/contacto/" class="btn btn-primary preview mt-2"><i class="fa-solid fa-angle-left"></i> Atras </a>
                <button type="button" class="btn btn-success convertBtn mt-2" style="display:none"> Generar codigo QR <i class="fa-solid fa-qrcode"></i></button>
